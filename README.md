...
<!----Descripción---->
Para esta materia empece a usar el lenguaje C#, que al final termino volviéndose mi lenguaje predilecto para trabajos grandes fueron creados usando una version anterior de Visual Studio Community a la mas reciente, por ello se actualizaron los proyectos con el SDK de NET Core 8.0.
<!----Separador de la descripción---->

<!----Notas---->
**Notas**
**- Los proyectos "ActividadPendienteOO" y "OtraActividadOO" son actividades que no pude pasar a proyectos propios en su momento, pero pude hacerlos tiempo después desde cero y los puse aquí, también fueron ejercicios que hice durante el periodo extraordinario para recuperar materias.**
...
###### Empleados - 31/01/20
Organización del nombre e información de empleados.

<!----Separador---->

###### Repaso - 01/02/20
Segunda version del programa "Empleados", esta vez como un programa separado.
...
Otra actividad no terminada, no hay muchas diferencias que se destaquen con la anterior.
